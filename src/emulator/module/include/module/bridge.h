...
void call(Ret (*export_fn)(HostState &, SceUID, const char *, Args...), const char *export_name, const std::tuple<ArgsLayout<Args...>, LayoutArgsStates<Args...>> &args_layout, std::index_sequence<indices...>, SceUID thread_id, CPUState &cpu, HostState &host) {
...
void call(void (*export_fn)(HostState &, SceUID, const char *, Args...), const char *export_name, const std::tuple<ArgsLayout<Args...>, LayoutArgsStates<Args...>> &args_layout, std::index_sequence<indices...>, SceUID thread_id, CPUState &cpu, HostState &host) {
...
ImportFn bridge(Ret (*export_fn)(HostState &, SceUID, const char *, Args...), const char *export_name) {
    constexpr std::tuple<ArgsLayout<Args...>, LayoutArgsStates<Args...>> args_layout = lay_out<typename BridgeTypes<Args>::ArmType...>();
